...
const dict: Record<string, { en: string; zh: string }> = {
  ...
  'cf.includeBoundary':{ en: 'Include boundary', zh: '包含边界' },
  'cf.direction':      { en: 'Direction', zh: '方向' },
  'cf.inward':         { en: 'Inward (outer → center)',    zh: '向内（外→中心）' },
  'cf.outwardInward':  { en: 'Outward-inward (center → outer)', zh: '由内向外（中心→外）' },
